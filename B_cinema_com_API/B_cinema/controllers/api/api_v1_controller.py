...
def api_buscar_tmdb():
    # Usamos request.args.get porque "q" é um parâmetro de query string (?q=...),
    # enviado em requisições GET. request.args.get também permite um valor padrão
    # ("" nesse caso), evitando erro (KeyError) se o parâmetro não for enviado.
